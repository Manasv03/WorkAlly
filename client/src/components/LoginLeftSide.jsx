...
const LoginLeftSide = () => {
  return (
    <div className='hidden md:flex w-1/2 bg-[#181A1B] relative overflow-hidden border-r border-slate-200'>
      
      <div className="absolute justify-content w-full h-full bg-slate-900 rounded-full blur-3xl"></div>
