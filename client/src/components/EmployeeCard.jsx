    ...
    <div className="group relative card card:hover overflow-hidden">
        <div className='relative aspect-4/3 w-full overflow-hidden bg-linear-to-br from-slate-100 to-slate-50'>
            ...
            <div className="w-full h-full flex items-center justify-center">
                {/* circle icon */}
                <div className="w-20 h-20 bg-linear-to-br from-indigo-100 to-slate-100 rounded-full flex items-center justify-center">
        ...
        <div className='absolute top-3 left-3 flex gap-2'>
            ...
            {employee.isDeleted && <spam className="bg-red-500/60 font-medium text-white px-2.5 py-1 text-xs rounded">DELETED</spam>}
        </div>
