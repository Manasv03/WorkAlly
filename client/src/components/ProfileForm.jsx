    ...
    <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
        ...
        <div className='space-y-5'>
            ...
            <div>
                ...
                <textarea name="bio" id="" disabled={initialData.isDeleted} defaultValue={initialData.bio || ""} placeholder='Write a brief bio...' className={`resize-none text-black/40 ${initialData.isDeleted ? "bg-slate-50 text-slate-400 cursor-not-allowed" : ""}`}/>
