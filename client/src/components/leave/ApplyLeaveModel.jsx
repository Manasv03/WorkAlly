        ...
        <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in' onClick={(e)=>e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className='p-6 space-y-5'>
                ...
                <div>
                    ...
                    <select name="type" required className='text-black/40'>
                ...
                <div>
                    ...
                    <textarea name="reason" required rows={3} className='resize-none' placeholder='Briefly describe why you eed this leave...'/>
                </div>
