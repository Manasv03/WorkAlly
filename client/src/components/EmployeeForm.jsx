...
const EmployeeForm = ({initialData, onSuccess, onCancel}) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
        ...
        <div className='card p-5 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                ...
                <div>
                    ...
                    <input type='number' name='deduction' required min={0} step={0.01} defaultValue={initialData?.deductions || 0}/>
                </div>
                {isEditMode && (
                    <div>
                        <div>
                            <label className='block mb-2'>Status</label>
                            <select name='employment Status' required defaultValue={initialData?.employmentStatus}>
        ...
        {/* Account Setup */}
        <div className='card p-5 sm:p-6'>
            <h3 className='text-base font-medium mb-6 pb-4 border-b text-slate-900 border-slate-100'>Account Setup</h3>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                <div className='sm:col-span-2'>
                ...
                {isEditMode && (
                    <div>
                        ...
                        <input type='passowrd' name='password' placeholder='Leave blank to keep current' />
                    </div>
                )}
                <div>
