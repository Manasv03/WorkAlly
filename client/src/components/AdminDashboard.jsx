...
const AdminDashboard = ({data}) => {
    ...
    const stats = [
        {icon: UserIcon ,value: data.totalEmployees,  label: "Total Employee",description: "Active workforce"},
        {icon: Building2Icon ,value: data.totalDepartments,  label: "Departments",description: "Organization units"},
  ...
  return (
    <div className='animate-fade-in'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 lg:grid-cols-4 sm:gap-5 mb-8'>
            {
            stats.map((s)=>(
                <div key={s.label} className='card card-hover p-5 sm:p-6 relative overflow-hidden group flex intems-center justify-between'>
                    <div>
