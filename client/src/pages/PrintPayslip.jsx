...
const PrintPayslip = () => {
  ...
  return (
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      ...
      <div className='rounded-xl border border-slate-900 overflow-hidden mb-8'>
        <table className='w-full text-sm'>
          ...
          <tbody>
            ...
            <tr className='border-t-2 bg-slate-50 border-slate-100'>
              <td className='py-3 px-4 text-slate-700 font-bold'>Net Salary</td>
